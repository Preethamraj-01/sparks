  ...
  <div class ="background ">
    <div class ="blur">
      ...
      <nav class="navbar navbar-expand-sm sticky-top navbar-dark">
        ...
        <img src="https://tse4.explicit.bing.net/th?id=OIP.6RGtMJH0fKrb9p5CixJAHwAAAA&pid=Api&P=0&w=170&h=169" height="70px" width="80px" alt="sparks logo"/>
          ...
          <table class="table table-sm table-condensed table-bordered">
            ...
            ?>
              <tr> 
                ...
                <td><a href="selecteduserdetail.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn"  >Select user</button></a></td>
              </tr>
            <?php                
              }
            ?>
      ...
      <footer class="text-center fixed-bottom mt-5 py-2">
        <div>
          <p>&copy 2022. G R Preetham<br> The Sparks Foundation </p>
        </div>
      </footer>
